...
const DataVisualization = () => {
	...
	const filteredTransactions = selectedProduct ? transactions.filter((transaction) => transaction.product.product_id === selectedProduct) : transactions;
	...
	return (
		...
		<div>
			...
			<select value={aggregationType} onChange={(e) => setFilterType(e.target.value)}>
			...
			{showDatePicker && (
				<DateRangePicker
					...
					onChange={(ranges) => {
						...
						//log dates between start date and end date
						let dates = [];
						let currentDate = ranges.selection.startDate;
