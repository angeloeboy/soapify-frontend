...
const ReportDiscrepancyModal = ({ purchaseOrderId, close, report }) => {
		...
		<ReportDiscrepancyModalContainer>
			<div className="inner">
				...
				<p className="modal-description">
					You are reporting a discrepancy in the receipt of purchase order {purchaseOrderId}. Please specify the quantity of items you have received and provide
