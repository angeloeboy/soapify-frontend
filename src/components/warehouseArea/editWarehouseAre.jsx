      ...
      <FieldContainer>
        ...
        <div>
          ...
          <InputHolder
            ...
            onChange={(e) =>
              setEditedWarehouseArea({ ...editedWarehouseArea, description: e.target.value })
            }
          />
        </div>
        <div>
          ...
          <InputHolder
            ...
            onChange={(e) =>
              setEditedWarehouseArea({ ...editedWarehouseArea, areaType: e.target.value })
            }
          />
        </div>
        <div>
          ...
          <InputHolder
            ...
            onChange={(e) =>
              setEditedWarehouseArea({ ...editedWarehouseArea, capacity: e.target.value })
            }
          />
        </div>
        <div>
          ...
          <InputHolder
            ...
            onChange={(e) =>
              setEditedWarehouseArea({ ...editedWarehouseArea, location: e.target.value })
            }
          />
        </div>
       </FieldContainer>
