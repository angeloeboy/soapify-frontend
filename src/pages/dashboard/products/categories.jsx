...
import EditCategoryComponent from "@/components/product/categories/editCategory";
const Categories = () => {
	...
	return (
		<DashboardLayout>
			...
			{isAddPopUpOpen && <AddCategoriesComponent setIsAddPopUpOpen={setIsAddPopUpOpen} fetchCategories={fetchCategories} />}
			{isEditCategoryOpen && <EditCategoryComponent onClose={closeEditPopUp} setEditCategoryOpen={setEditCategoryOpen} />}
		</DashboardLayout>
	);
};
