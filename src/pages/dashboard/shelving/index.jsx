...
const Shelving = () => {
	...
	return (
		<DashboardLayout>
			...
			<StyledPanel>
				<ShelvingSearchBar setIsAddShelfPopupOpen={setIsAddShelfPopupOpen} setShelvesDisplay={setFilteredShelves} onSearch={handleSearchShelves} />
			...
			{isAddShelfPopupOpen && <AddShelvingComponent setIsAddShelfPopupOpen={setIsAddShelfPopupOpen} getShelvesFunc={getShelvesFunc} />}
		</DashboardLayout>
	);
};
