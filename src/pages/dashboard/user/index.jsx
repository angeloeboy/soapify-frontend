...
import ItemActionModal,{Button,Select,LabelContainer,Label,Option,FieldContainer,ProfilePictureContainer,FileInput,Centered,SecondaryButton,CloseButton,ButtonsContainer,PopupOverlay,PopupContent,HeaderTitle,FieldTitleLabel,InputHolder } from "@/components/styled-components/ItemActionModal"; 
 	...
 	return (
 	  <PopupOverlay>
		<PopupContent>
		  ...
		  <FieldContainer>
		<LabelContainer first><Label>General Information</Label> </LabelContainer>	 
		<div>
	...
	return (
	  <DashboardLayout>
		<StyledPanel>
		  ...
		  {isPopupOpen && (
			<Popup onClose={handleClosePopup} onButtonClick={onButtonClick} fileInput={fileInput} />
		  )}
		</StyledPanel>
	  </DashboardLayout>
	);
