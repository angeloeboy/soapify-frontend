...
const RefundPage = () => {
	...
	const handleSearch = (searchTerm) => {
		const filtered = refunds.filter((refund) => {
			return refund.customerInfo.toLowerCase().includes(searchTerm.toLowerCase()) || refund.productName.toLowerCase().includes(searchTerm.toLowerCase());
		});
	...
	return (
		<DashboardLayout>
			...
			{isEditPopUpOpen && <EditRefundComponent setIsEditPopUpOpen={setIsEditPopUpOpen} />}
		</DashboardLayout>
	);
};
