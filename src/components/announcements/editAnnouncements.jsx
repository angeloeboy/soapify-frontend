...
const EditAnnouncement = ({ selectedAnnouncement, onClose, fetchAnnouncements }) => {
	...
	const editAnnouncementFunc = async () => {
		const response = await editAnnouncement(announcement);
		...
		<PopupOverlay>
			<PopupContent>
				...
				<ButtonsContainer>
					...
					<Button onClick={() => editAnnouncementFunc()}>Save</Button>
				</ButtonsContainer>
