...
const EditPromoComponent = ({ setIsEditPopUpOpen, getPromosFunc }) => {
  ...
  const editPromoFunc = async (e) => {
    e.preventDefault();
    await editPromo(promo).then((res) => {
      console.log(res);
    });
  ...
  return (
    <PopupOverlay>
      <PopupContent>
        <form onSubmit={(e) => editPromoFunc(e)}>
          ...
          <FieldContainer>
            ...
            <div>
              ...
              <InputHolder
                ...
                onChange={(e) =>
                  setPromo({ ...promo, promoID: e.target.value })
                }
              />
            </div>
            <div>
            ...
            <div>
              ...
              <InputHolder
                ...
                onChange={(e) =>
                  setPromo({ ...promo, promoName: e.target.value })
                }
              />
            </div>
            <div>
              ...
              <InputHolder
                ...
                onChange={(e) =>
                  setPromo({ ...promo, promoType: e.target.value })
                }
              />
            </div>
            <div>
...
export default EditPromoComponent;
