...
const EditReturnComponent = ({ setIsEditPopUpOpen, getReturnsFunc }) => {
  ...
  const editReturnFunc = async (e) => {
    e.preventDefault();
    await aeditReturn(returnData).then((res) => {
      console.log(res);
    });
  ...
  return (
    <PopupOverlay>
      <PopupContent>
        <form onSubmit={(e) => editReturnFunc(e)}>
          <HeaderTitle>Edit Return</HeaderTitle>
          <FieldContainer>
            <div>
...
export default EditReturnComponent;
