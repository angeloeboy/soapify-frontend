...
const Sidebar = () => {
	...
	return (
		<SidebarContainer className="sidebar">
			...
			<Menu className="inventory-menu with-submenu" onClick={handleInventorySubMenuToggle}>
				Inventory
			...
			<Menu className="settings-menu with-submenu" onClick={handleSettingsSubMenuToggle}>
				Settings
			...
			<Link href="/dashboard/products"> Test</Link>
		</SidebarContainer>
	);
};
